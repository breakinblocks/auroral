...
A comprehensive winter expansion mod for Minecraft 26.1.2 (NeoForge 26.1.2.22-beta) centered around celestial energy, mystical metallurgy, and specialized survival.
...
- **Mod Loader**: NeoForge 26.1.2.22-beta
